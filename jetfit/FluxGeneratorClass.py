...
class FluxGeneratorClass:
    ...
    def GetTaus(self, Times, P):
        ...
        f0 = (P['n']/P['E'])**(1./3.)/(1.+P['z']) #Formula from the paper for the scaled time
        Taus = f0 * Times 
        return Taus
    ...
    def GetTransformedValue(self, Taus, P):
        ...
        #print('from cod transformed value F_peak, nu_c, nu_m',f_peak, f_nu_c, f_nu_m)
    ...
    def GetSpectral(self, Times, Freqs, P):
        ...
        #print('from getspectral F_peak, nu_c, nu_m',F_peak, nu_c, nu_m)
